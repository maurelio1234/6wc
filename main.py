...
print 'Current challenge started at {:%Y-%m-%d} and will finish at {:%Y-%m-%d}'.format(start_date,end_date)
...
h,m = process.minutes2hm(process.compute_acc(reference_start=model.get_reference_date(),reference_end=end_date, duration=model.get_duration()))
